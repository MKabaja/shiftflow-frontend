...
const interactiveStyles: string =
  'cursor-pointer transition-[transform,box-shadow] duration-200 ease-out hover:-translate-y-[3px] hover:shadow-nm-raised-lg active:translate-y-0 active:shadow-nm-pressed';
